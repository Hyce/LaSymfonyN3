...
class AdminRealisateurController extends Controller
{
    ...
    {
        $realisateurs = $this->getDoctrine()->getRepository('DevschoolFilmBundle:Realisateur')->findAll();
    ...
    public function editAction(Request $request, $id)
    {
        ...
        $realisateur = $this->getDoctrine()->getRepository('DevschoolFilmBundle:Realisateur')->find($id);
